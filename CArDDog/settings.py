"""
Django settings for CArDDog project.
...
SECRET_KEY = 'n*d84tb9)!a47-i-6wd%*2ya^n@kq$vuzne=0qa4mv#qs$5z@+'
...
WSGI_APPLICATION = 'CArDDog.wsgi.application'
